# AGENTS.md - Claude Code Agent System Guide

## Overview

This is an **Claude Code Agent System** repository - a framework for AI-driven development with plan-first workflows and approval-based execution. This guide helps agentic coding assistants understand the codebase structure, build commands, and coding standards.
...
### Package Management
```bash
# Install dependencies (in .Claude/ directory)

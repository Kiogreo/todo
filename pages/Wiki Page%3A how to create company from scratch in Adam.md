...
- # Step by step instruction
	...
	- Once submitted, it may re-direct you to `https://adam-procure.com/`, but you should go back into Adam & login using the new user credential
	  logseq.order-list-type:: number
	- It should give the below screen. You may proceed to `Resend Link` to get your email verification link or `Sign In as Different User` to continue sign in as your new Adam user.
	  logseq.order-list-type:: number
